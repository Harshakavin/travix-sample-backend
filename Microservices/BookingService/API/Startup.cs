...
namespace TravixBackend.BookingService.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Scan(scan => scan
                        ...
                        .AddClasses(classes => classes.InNamespaces("TravixBackend.BookingService.Domain.Services"))
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                endpoints.MapGrpcService<GrpcServices.BookingService>();
            });
        }
